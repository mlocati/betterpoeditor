namespace BePoE.UI
{
	partial class frmOptions
	{
		...
		private void InitializeComponent()
		{
			...
			this.tpBingTranslator = new System.Windows.Forms.TabPage();
			this.tableLayoutPanel1 = new System.Windows.Forms.TableLayoutPanel();
			this.tbxBingTranslatorClientSecret = new System.Windows.Forms.TextBox();
			this.label45 = new System.Windows.Forms.Label();
			this.label44 = new System.Windows.Forms.Label();
			this.tbxBingTranslatorClientID = new System.Windows.Forms.TextBox();
			this.flpBing = new System.Windows.Forms.FlowLayoutPanel();
			...
			this.lnkBTSampleURI = new System.Windows.Forms.LinkLabel();
			...
			// tpBingTranslator
			// 
			this.tpBingTranslator.Controls.Add(this.tableLayoutPanel1);
			this.tpBingTranslator.Controls.Add(this.flpBing);
			this.tpBingTranslator.Location = new System.Drawing.Point(4, 22);
			this.tpBingTranslator.Name = "tpBingTranslator";
			this.tpBingTranslator.Padding = new System.Windows.Forms.Padding(3);
			this.tpBingTranslator.Size = new System.Drawing.Size(483, 323);
			this.tpBingTranslator.TabIndex = 4;
			this.tpBingTranslator.Text = "Bing Translator";
			this.tpBingTranslator.UseVisualStyleBackColor = true;
			// 
			// tableLayoutPanel1
			// 
			...
			this.tableLayoutPanel1.Controls.Add(this.tbxBingTranslatorClientSecret, 1, 1);
			this.tableLayoutPanel1.Controls.Add(this.label45, 0, 1);
			this.tableLayoutPanel1.Controls.Add(this.label44, 0, 0);
			this.tableLayoutPanel1.Controls.Add(this.tbxBingTranslatorClientID, 1, 0);
			...
			// 
			// tbxBingTranslatorClientSecret
			// 
			this.tbxBingTranslatorClientSecret.Dock = System.Windows.Forms.DockStyle.Fill;
			this.tbxBingTranslatorClientSecret.Location = new System.Drawing.Point(123, 29);
			this.tbxBingTranslatorClientSecret.Name = "tbxBingTranslatorClientSecret";
			this.tbxBingTranslatorClientSecret.Size = new System.Drawing.Size(351, 20);
			this.tbxBingTranslatorClientSecret.TabIndex = 3;
			// 
			// label45
			// 
			this.label45.AutoSize = true;
			this.label45.Location = new System.Drawing.Point(0, 32);
			this.label45.Margin = new System.Windows.Forms.Padding(0, 6, 0, 0);
			this.label45.Name = "label45";
			this.label45.Size = new System.Drawing.Size(67, 13);
			this.label45.TabIndex = 2;
			this.label45.Text = "Client Secret";
			// 
			// label44
			// 
			...
			// 
			// tbxBingTranslatorClientID
			// 
			this.tbxBingTranslatorClientID.Dock = System.Windows.Forms.DockStyle.Fill;
			this.tbxBingTranslatorClientID.Location = new System.Drawing.Point(123, 3);
			this.tbxBingTranslatorClientID.Name = "tbxBingTranslatorClientID";
			this.tbxBingTranslatorClientID.Size = new System.Drawing.Size(351, 20);
			this.tbxBingTranslatorClientID.TabIndex = 1;
			// 
			// flpBing
			// 
			this.flpBing.AutoSize = true;
			this.flpBing.AutoSizeMode = System.Windows.Forms.AutoSizeMode.GrowAndShrink;
			this.flpBing.Controls.Add(this.label8);
			this.flpBing.Controls.Add(this.linkLabel1);
			this.flpBing.Controls.Add(this.label10);
			this.flpBing.Controls.Add(this.label21);
			this.flpBing.Controls.Add(this.label22);
			this.flpBing.Controls.Add(this.linkLabel2);
			this.flpBing.Controls.Add(this.label23);
			this.flpBing.Controls.Add(this.label24);
			this.flpBing.Controls.Add(this.linkLabel3);
			this.flpBing.Controls.Add(this.label25);
			this.flpBing.Controls.Add(this.label30);
			this.flpBing.Controls.Add(this.label26);
			this.flpBing.Controls.Add(this.label27);
			this.flpBing.Controls.Add(this.label28);
			this.flpBing.Controls.Add(this.linkLabel4);
			this.flpBing.Controls.Add(this.label29);
			this.flpBing.Controls.Add(this.label31);
			this.flpBing.Controls.Add(this.linkLabel5);
			this.flpBing.Controls.Add(this.label32);
			this.flpBing.Controls.Add(this.label33);
			this.flpBing.Controls.Add(this.label34);
			this.flpBing.Controls.Add(this.label35);
			this.flpBing.Controls.Add(this.label36);
			this.flpBing.Controls.Add(this.label37);
			this.flpBing.Controls.Add(this.label38);
			this.flpBing.Controls.Add(this.label39);
			this.flpBing.Controls.Add(this.label40);
			this.flpBing.Controls.Add(this.lnkBTSampleURI);
			this.flpBing.Controls.Add(this.label41);
			this.flpBing.Controls.Add(this.label42);
			this.flpBing.Controls.Add(this.label43);
			this.flpBing.Dock = System.Windows.Forms.DockStyle.Top;
			this.flpBing.Location = new System.Drawing.Point(3, 3);
			this.flpBing.Name = "flpBing";
			this.flpBing.Padding = new System.Windows.Forms.Padding(5);
			this.flpBing.Size = new System.Drawing.Size(477, 192);
			this.flpBing.TabIndex = 0;
			// 
			// label8
			// 
			...
			this.label8.Text = "To activate the Bing translation you have to follow the instructions";
			// 
			// linkLabel1
			// 
			this.linkLabel1.AutoSize = true;
			this.linkLabel1.Location = new System.Drawing.Point(322, 5);
			this.linkLabel1.Margin = new System.Windows.Forms.Padding(0);
			this.linkLabel1.Name = "linkLabel1";
			this.linkLabel1.Size = new System.Drawing.Size(70, 13);
			this.linkLabel1.TabIndex = 1;
			this.linkLabel1.TabStop = true;
			this.linkLabel1.Tag = "http://blogs.msdn.com/b/translation/p/gettingstarted1.aspx";
			this.linkLabel1.Text = "reported here";
			this.linkLabel1.VisitedLinkColor = System.Drawing.Color.Blue;
			this.linkLabel1.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.linkLabelTag_LinkClicked);
			// 
			// label10
			// 
			...
			this.label22.Text = "1. If you don\'t have a Live ID you have to";
			// 
			// linkLabel2
			// 
			this.linkLabel2.AutoSize = true;
			this.linkLabel2.Location = new System.Drawing.Point(208, 31);
			...
			this.linkLabel2.Tag = "https://signup.live.com/";
			this.linkLabel2.Text = "get a Windows Live ID";
			this.linkLabel2.VisitedLinkColor = System.Drawing.Color.Blue;
			this.linkLabel2.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.linkLabelTag_LinkClicked);
			// 
			// label23
			// 
			this.label23.AutoSize = true;
			this.flpBing.SetFlowBreak(this.label23, true);
			this.label23.Location = new System.Drawing.Point(323, 31);
			...
			this.label24.Text = "2. Subscribe to the";
			// 
			// linkLabel3
			// 
			this.linkLabel3.AutoSize = true;
			this.linkLabel3.Location = new System.Drawing.Point(101, 44);
			...
			this.linkLabel3.Tag = "https://datamarket.azure.com/dataset/1899a118-d202-492c-aa16-ba21c33c06cb";
			this.linkLabel3.Text = "Translate service";
			this.linkLabel3.VisitedLinkColor = System.Drawing.Color.Blue;
			this.linkLabel3.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.linkLabelTag_LinkClicked);
			// 
			// label25
			// 
			this.label25.AutoSize = true;
			this.label25.Location = new System.Drawing.Point(189, 44);
			this.label25.Margin = new System.Windows.Forms.Padding(0);
			this.label25.Name = "label25";
			this.label25.Size = new System.Drawing.Size(175, 13);
			this.label25.TabIndex = 9;
			this.label25.Text = "of the Windows Azure marketplace.";
			// 
			// label30
			// 
			this.label30.AutoSize = true;
			this.flpBing.SetFlowBreak(this.label30, true);
			this.label30.Location = new System.Drawing.Point(5, 57);
			this.label30.Margin = new System.Windows.Forms.Padding(0);
			this.label30.Name = "label30";
			this.label30.Size = new System.Drawing.Size(419, 26);
			this.label30.TabIndex = 10;
			this.label30.Text = "Please note that there\'s a free plan offering up to 2,000,000 characters/month an" +
				 "d 400 characters/hour.";
			// 
			// label26
			// 
			...
			this.label26.Text = "3. Mark down your";
			// 
			// label27
			// 
			this.label27.AutoSize = true;
			this.label27.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.label27.Location = new System.Drawing.Point(100, 83);
			...
			this.label28.Location = new System.Drawing.Point(176, 83);
			this.label28.Margin = new System.Windows.Forms.Padding(0);
			this.label28.Name = "label28";
			this.label28.Size = new System.Drawing.Size(99, 13);
			this.label28.TabIndex = 13;
			this.label28.Text = "that you find in your";
			// 
			// linkLabel4
			// 
			this.linkLabel4.AutoSize = true;
			this.linkLabel4.Location = new System.Drawing.Point(275, 83);
			...
			this.linkLabel4.Tag = "https://datamarket.azure.com/account/info";
			this.linkLabel4.Text = "profile page";
			this.linkLabel4.VisitedLinkColor = System.Drawing.Color.Blue;
			this.linkLabel4.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.linkLabelTag_LinkClicked);
			// 
			// label29
			// 
			this.label29.AutoSize = true;
			this.flpBing.SetFlowBreak(this.label29, true);
			this.label29.Location = new System.Drawing.Point(337, 83);
			...
			this.label31.Text = "4. Register an app on the";
			// 
			// linkLabel5
			// 
			this.linkLabel5.AutoSize = true;
			this.linkLabel5.Location = new System.Drawing.Point(132, 96);
			...
			this.linkLabel5.Tag = "https://datamarket.azure.com/developer/applications";
			this.linkLabel5.Text = "Azure Marketplace";
			this.linkLabel5.VisitedLinkColor = System.Drawing.Color.Blue;
			this.linkLabel5.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.linkLabelTag_LinkClicked);
			// 
			// label32
			// 
			this.label32.AutoSize = true;
			this.flpBing.SetFlowBreak(this.label32, true);
			this.label32.Location = new System.Drawing.Point(228, 96);
			this.label32.Margin = new System.Windows.Forms.Padding(0);
			this.label32.Name = "label32";
			this.label32.Size = new System.Drawing.Size(115, 13);
			this.label32.TabIndex = 18;
			this.label32.Text = "with the following data:";
			// 
			// label33
			// 
			this.label33.AutoSize = true;
			this.label33.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.label33.Location = new System.Drawing.Point(20, 109);
			this.label33.Margin = new System.Windows.Forms.Padding(15, 0, 0, 0);
			...
			this.flpBing.SetFlowBreak(this.label34, true);
			this.label34.Location = new System.Drawing.Point(96, 109);
			this.label34.Margin = new System.Windows.Forms.Padding(0);
			this.label34.Name = "label34";
			this.label34.Size = new System.Drawing.Size(185, 13);
			this.label34.TabIndex = 20;
			this.label34.Text = "the one you found in your profile page";
			// 
			// label35
			// 
			this.label35.AutoSize = true;
			this.label35.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.label35.Location = new System.Drawing.Point(20, 122);
			this.label35.Margin = new System.Windows.Forms.Padding(15, 0, 0, 0);
			...
			this.flpBing.SetFlowBreak(this.label36, true);
			this.label36.Location = new System.Drawing.Point(59, 122);
			this.label36.Margin = new System.Windows.Forms.Padding(0);
			this.label36.Name = "label36";
			this.label36.Size = new System.Drawing.Size(112, 13);
			this.label36.TabIndex = 22;
			this.label36.Text = "a name of your choice";
			// 
			// label37
			// 
			this.label37.AutoSize = true;
			this.label37.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.label37.Location = new System.Drawing.Point(20, 135);
			this.label37.Margin = new System.Windows.Forms.Padding(15, 0, 0, 0);
			this.label37.Name = "label37";
			this.label37.Size = new System.Drawing.Size(78, 13);
			this.label37.TabIndex = 23;
			this.label37.Text = "Client secret";
			// 
			// label38
			// 
			this.label38.AutoSize = true;
			this.flpBing.SetFlowBreak(this.label38, true);
			this.label38.Location = new System.Drawing.Point(98, 135);
			this.label38.Margin = new System.Windows.Forms.Padding(0);
			this.label38.Name = "label38";
			this.label38.Size = new System.Drawing.Size(190, 13);
			this.label38.TabIndex = 24;
			this.label38.Text = "should be pre-compiled (take note of it)";
			// 
			// label39
			// 
			this.label39.AutoSize = true;
			this.label39.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.label39.Location = new System.Drawing.Point(20, 148);
			this.label39.Margin = new System.Windows.Forms.Padding(15, 0, 0, 0);
			this.label39.Name = "label39";
			this.label39.Size = new System.Drawing.Size(81, 13);
			this.label39.TabIndex = 25;
			this.label39.Text = "Redirect URI";
			// 
			// label40
			// 
			this.label40.AutoSize = true;
			this.label40.Location = new System.Drawing.Point(101, 148);
			this.label40.Margin = new System.Windows.Forms.Padding(0);
			this.label40.Name = "label40";
			this.label40.Size = new System.Drawing.Size(100, 13);
			this.label40.TabIndex = 27;
			this.label40.Text = "fill in something like ";
			// 
			// lnkBTSampleURI
			// 
			this.lnkBTSampleURI.AutoSize = true;
			this.flpBing.SetFlowBreak(this.lnkBTSampleURI, true);
			this.lnkBTSampleURI.Location = new System.Drawing.Point(201, 148);
			this.lnkBTSampleURI.Margin = new System.Windows.Forms.Padding(0);
			this.lnkBTSampleURI.Name = "lnkBTSampleURI";
			this.lnkBTSampleURI.Size = new System.Drawing.Size(268, 13);
			this.lnkBTSampleURI.TabIndex = 26;
			this.lnkBTSampleURI.TabStop = true;
			this.lnkBTSampleURI.Tag = "";
			this.lnkBTSampleURI.Text = "https://localhost/AzureMarketplaceOAuthHandler.ashx";
			this.lnkBTSampleURI.VisitedLinkColor = System.Drawing.Color.Blue;
			this.lnkBTSampleURI.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.lnkBTSampleURI_LinkClicked);
			// 
			// label41
			// 
			this.label41.AutoSize = true;
			this.label41.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.label41.Location = new System.Drawing.Point(20, 161);
			this.label41.Margin = new System.Windows.Forms.Padding(15, 0, 0, 0);
			...
			this.flpBing.SetFlowBreak(this.label42, true);
			this.label42.Location = new System.Drawing.Point(91, 161);
			...
			this.label42.Text = "a description of your choice";
			// 
			// label43
			// 
			this.label43.AutoSize = true;
			this.flpBing.SetFlowBreak(this.label43, true);
			this.label43.Location = new System.Drawing.Point(5, 174);
		...
		private System.Windows.Forms.TabPage tpBingTranslator;
		private System.Windows.Forms.FlowLayoutPanel flpBing;
		...
		private System.Windows.Forms.LinkLabel lnkBTSampleURI;
		private System.Windows.Forms.Label label41;
		private System.Windows.Forms.Label label42;
		private System.Windows.Forms.TableLayoutPanel tableLayoutPanel1;
		private System.Windows.Forms.Label label43;
		private System.Windows.Forms.TextBox tbxBingTranslatorClientSecret;
